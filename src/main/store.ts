...
export function getSummarisationEnabled(): boolean {
  return getLLMSettings().summarisationEnabled ?? true
}

export function setSummarisationEnabled(enabled: boolean): void {
