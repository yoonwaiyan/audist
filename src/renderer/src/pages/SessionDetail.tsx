        ...
        {activeTab === 'Summary' && (
          summaryError ? (
            ...
            <div className="flex flex-col items-center text-center mt-16">
              <div className="w-16 h-16 rounded-full bg-[var(--color-bg-surface)] border border-[var(--color-border)] flex items-center justify-center mb-6">
                <FileQuestion className="w-8 h-8 text-[var(--color-text-muted)]" />
              </div>
              <h3 className="text-xl font-semibold text-[var(--color-text-primary)] mb-2">No AI Summary Available</h3>
              <p className="text-sm text-[var(--color-text-secondary)] mb-6 max-w-md leading-relaxed">
                This session doesn't have an AI-generated summary yet. This might be because summarization failed or hasn't been run yet.
              </p>
              <button
                onClick={handleRetry}
                disabled={retrying}
              ...
              <p className="text-xs text-[var(--color-text-muted)] mt-4">
                Summary will be generated using your configured LLM provider
              </p>
            </div>
          )
        )}
